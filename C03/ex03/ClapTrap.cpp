...
/*   Updated: 2023/02/22 17:53:19 by eavilov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ClapTrap::takeDamage(unsigned int amount)
{
    ...
    else
    {
        ...
        std::cout << " (" << this->hitPoints + amount << " -> " << this->hitPoints << ")" << std::endl;
    }
}
...
void    ClapTrap::beRepaired(unsigned int amount)
{
    ...
    else
    {
        this->hitPoints += amount;
        this->energyPoints -= 1;
        std::cout << this->name << " drinks some weird white sticky liquid, restoring " << amount << " hp!";
        std::cout << " (" << this->hitPoints - amount << " -> " << this->hitPoints << ")" << std::endl;
    }
}
